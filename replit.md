...
- **TRUE 3-second delay**: GLOBAL scan block prevents ALL scans for 3 seconds (not just same barcode)
- **Visual indicators**: "READY" when active, "WAIT 3 SEC" orange overlay when blocked
